...
window.DASHBOARD_DATA = {
  ...
  '12m': {
    label: '2025 + 2026 YTD', shortLabel: '2025–26 YTD',
    rev: '€67,726', revD: '2025 + 2026 actuals', revC: 'du', revS: '',
    adSales: '€34,144', adSalesD: '2025 + 2026 actuals', adSalesC: 'df', adSalesS: '50.4% of revenue',
    tacos: '25.3%', tacosD: '', tacosC: 'df', tacosS: 'Target <20%',
    roas: '3.95×', roasD: '', roasC: 'df', roasS: '',
    spend: '€17,158', spendD: '2025 + 2026 actuals', spendC: 'df', spendS: '',
    tacosAd: '25.3%', tacosAdD: '', tacosAdC: 'df', tacosAdS: 'Target <20%',
    roasAd: '3.95×', roasAdD: '', roasAdC: 'df', roasAdS: '€67,726 revenue',
    aov: '€31.18', aovD: '', aovC: 'df', aovS: '',
    mktRows: [
      ['DE','de','€15,980','€8,242','bg','▼ €7,738 under','€34,429','ba','23.9%'],
      ['FR','fr','€4,250','€2,998','bg','▼ €1,252 under','€9,966','br','30.1%'],
      ['ES','es','€2,600','€2,537','bg','▼ €63 under','€9,792','ba','25.9%'],
      ['IT','it','€4,300','€3,382','bg','▼ €918 under','€13,539','ba','25.0%'],
      ['NLD','nl','€0','€0','bb','Early launch','€0','bb','—'],
      ['Total EU',null,'€27,130','€17,158','bg','63% utilised','€67,726','ba','25.3%']
    ],
    campaignMix: { slices:[ {name:'Sponsored Products',color:'#404935',pct:82.5,sales:'€28.7k',acos:'45.1%'}, {name:'Sponsored Brands',color:'#6b7160',pct:9.3,sales:'€4.5k',acos:'32.6%'}, {name:'Sponsored Display',color:'#a7ab90',pct:8.3,sales:'€0.0k',acos:'n/a'} ] },
  }
  },
