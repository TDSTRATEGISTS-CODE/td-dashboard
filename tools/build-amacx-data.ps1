...
$mixJs = "{ slices:[ {name:'Sponsored Products',color:'#404935',pct:82.5,sales:'${EUR}28.7k',acos:'45.1%'}, {name:'Sponsored Brands',color:'#9caf78',pct:9.3,sales:'${EUR}4.5k',acos:'32.6%'}, {name:'Sponsored Display',color:'#e8a87c',pct:8.3,sales:'${EUR}0.0k',acos:'n/a'} ] }"
...
$advJs = @"
{
      ...
      campaignMixByPeriod: {
        'may': {
          all: { slices:[ {name:'Sponsored Products',color:'#404935',pct:80.7,sales:'${EUR}3.8k',acos:'42.1%'}, {name:'Sponsored Brands',color:'#9caf78',pct:19.3,sales:'${EUR}0.9k',acos:'45.3%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          de: { slices:[ {name:'Sponsored Products',color:'#404935',pct:61.9,sales:'${EUR}0.8k',acos:'46.7%'}, {name:'Sponsored Brands',color:'#9caf78',pct:38.1,sales:'${EUR}0.5k',acos:'31.6%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          fr: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}1.2k',acos:'50.8%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          es: { slices:[ {name:'Sponsored Products',color:'#404935',pct:58.1,sales:'${EUR}0.6k',acos:'54.3%'}, {name:'Sponsored Brands',color:'#9caf78',pct:41.9,sales:'${EUR}0.5k',acos:'58.1%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          it: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}1.3k',acos:'25.7%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] }
        },
        '3m': {
          all: { slices:[ {name:'Sponsored Products',color:'#404935',pct:78.9,sales:'${EUR}9.2k',acos:'41.9%'}, {name:'Sponsored Brands',color:'#9caf78',pct:21.1,sales:'${EUR}2.5k',acos:'31.9%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          de: { slices:[ {name:'Sponsored Products',color:'#404935',pct:57,sales:'${EUR}2.5k',acos:'45.9%'}, {name:'Sponsored Brands',color:'#9caf78',pct:43,sales:'${EUR}1.9k',acos:'19.6%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          fr: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}2.4k',acos:'46.0%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          es: { slices:[ {name:'Sponsored Products',color:'#404935',pct:75.4,sales:'${EUR}1.8k',acos:'44.6%'}, {name:'Sponsored Brands',color:'#9caf78',pct:24.6,sales:'${EUR}0.6k',acos:'69.1%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          it: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}2.5k',acos:'32.0%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] }
        },
        '6m': {
          all: { slices:[ {name:'Sponsored Products',color:'#404935',pct:80.5,sales:'${EUR}12.9k',acos:'33.8%'}, {name:'Sponsored Brands',color:'#9caf78',pct:19.5,sales:'${EUR}3.1k',acos:'30.4%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          de: { slices:[ {name:'Sponsored Products',color:'#404935',pct:59.9,sales:'${EUR}3.8k',acos:'33.2%'}, {name:'Sponsored Brands',color:'#9caf78',pct:40.1,sales:'${EUR}2.5k',acos:'20.9%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          fr: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}3.0k',acos:'40.2%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          es: { slices:[ {name:'Sponsored Products',color:'#404935',pct:79.9,sales:'${EUR}2.4k',acos:'38.4%'}, {name:'Sponsored Brands',color:'#9caf78',pct:20.1,sales:'${EUR}0.6k',acos:'69.1%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          it: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}3.7k',acos:'26.2%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] }
        },
        '2025': {
          all: { slices:[ {name:'Sponsored Products',color:'#404935',pct:92,sales:'${EUR}19.6k',acos:'50.6%'}, {name:'Sponsored Brands',color:'#9caf78',pct:7.8,sales:'${EUR}1.7k',acos:'34.7%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0.2,sales:'${EUR}0.0k',acos:'n/a'} ] },
          de: { slices:[ {name:'Sponsored Products',color:'#404935',pct:87.8,sales:'${EUR}12.0k',acos:'44.8%'}, {name:'Sponsored Brands',color:'#9caf78',pct:12,sales:'${EUR}1.6k',acos:'33.1%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0.3,sales:'${EUR}0.0k',acos:'n/a'} ] },
          fr: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}2.0k',acos:'72.4%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          es: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}1.9k',acos:'65.1%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          it: { slices:[ {name:'Sponsored Products',color:'#404935',pct:99.4,sales:'${EUR}3.7k',acos:'50.2%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0.6,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] }
        },
        '12m': {
          all: { slices:[ {name:'Sponsored Products',color:'#404935',pct:86.4,sales:'${EUR}28.7k',acos:'45.1%'}, {name:'Sponsored Brands',color:'#9caf78',pct:13.4,sales:'${EUR}4.5k',acos:'32.6%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0.1,sales:'${EUR}0.0k',acos:'n/a'} ] },
          de: { slices:[ {name:'Sponsored Products',color:'#404935',pct:77.2,sales:'${EUR}13.1k',acos:'44.2%'}, {name:'Sponsored Brands',color:'#9caf78',pct:22.6,sales:'${EUR}3.8k',acos:'26.1%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0.2,sales:'${EUR}0.0k',acos:'n/a'} ] },
          fr: { slices:[ {name:'Sponsored Products',color:'#404935',pct:100,sales:'${EUR}4.7k',acos:'52.9%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          es: { slices:[ {name:'Sponsored Products',color:'#404935',pct:87,sales:'${EUR}4.0k',acos:'52.6%'}, {name:'Sponsored Brands',color:'#9caf78',pct:13,sales:'${EUR}0.6k',acos:'69.1%'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] },
          it: { slices:[ {name:'Sponsored Products',color:'#404935',pct:99.7,sales:'${EUR}6.9k',acos:'37.0%'}, {name:'Sponsored Brands',color:'#9caf78',pct:0.3,sales:'${EUR}0.0k',acos:'n/a'}, {name:'Sponsored Display',color:'#e8a87c',pct:0,sales:'${EUR}0.0k',acos:'n/a'} ] }
        }
      }
    }
"@
...
$ovJs = @"
{
      ...
      buyBoxLosses: [
        ...
        {name:'Nougat Bar Cranberry',asin:'B0CRC9DYT1',ean:'8714411001120',market:'de',reason:'Losing to Others',rc:'ba',your:'${EUR}32.95',winner:'${EUR}29.95',gap:'+${EUR}3.00'},
        ...
        {name:'Energy Gel Citrus',asin:'B0CRFD8L2X',ean:'8714411000208',market:'it',reason:'No Winner',rc:'ba',your:'${EUR}29.95',winner:'n/a',gap:''},
        ...
        {name:'Nougat Bar Cranberry',asin:'B0CRC9DYT1',ean:'8714411001120',market:'it',reason:'No Winner',rc:'ba',your:'${EUR}32.95',winner:'n/a',gap:''},
        {name:'Energy Gel Orange',asin:'B0CRFCLQJ1',ean:'8714411000222',market:'it',reason:'No Winner',rc:'ba',your:'${EUR}29.95',winner:'n/a',gap:''},
        {name:'Recovery/Protein Vanilla',asin:'B0F38FWCSV',ean:'8714411000178',market:'it',reason:'No Winner',rc:'ba',your:'${EUR}49.95',winner:'n/a',gap:''},
        ...
        {name:'Energy Gel Raspberry',asin:'B0CRFW8KR7',ean:'8714411000239',market:'it',reason:'No Winner',rc:'ba',your:'${EUR}29.95',winner:'n/a',gap:''},
        {name:'Recovery/Protein Chocolate',asin:'B0F38H49R3',ean:'8714411000185',market:'it',reason:'No Winner',rc:'ba',your:'${EUR}49.95',winner:'n/a',gap:''},
        {name:'Hydro Tabs Forest Fruit',asin:'B0CCJWLKTM',ean:'8714411000383',market:'fr',reason:'No Winner',rc:'ba',your:'${EUR}24.95',winner:'n/a',gap:''},
        {name:'Recovery/Protein Chocolate',asin:'B0F38H49R3',ean:'8714411000185',market:'fr',reason:'No Winner',rc:'ba',your:'${EUR}49.95',winner:'n/a',gap:''},
        {name:'Energy Ice Gel Cola Lime',asin:'B0F331SKR5',ean:'8714411002929',market:'de',reason:'No Winner',rc:'ba',your:'${EUR}79.95',winner:'n/a',gap:''},
        {name:'Hydro Tabs Lime',asin:'B0CCJWBX6W',ean:'8714411000338',market:'fr',reason:'No Winner',rc:'ba',your:'${EUR}24.95',winner:'n/a',gap:''},
        ...
        {name:'Recovery/Protein Vanilla',asin:'B0F38FWCSV',ean:'8714411000178',market:'es',reason:'No Winner',rc:'ba',your:'${EUR}49.95',winner:'n/a',gap:''},
        {name:'Turbo Gel Citrus',asin:'B0C9MZVSZW',ean:'8714411000536',market:'es',reason:'No Winner',rc:'ba',your:'${EUR}42.95',winner:'n/a',gap:''},
        {name:'Energy Ice Gel Cola Lime',asin:'B0F331SKR5',ean:'8714411002929',market:'fr',reason:'No Winner',rc:'ba',your:'${EUR}79.95',winner:'n/a',gap:''},
